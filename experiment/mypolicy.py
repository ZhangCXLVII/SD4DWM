...
class MyPolicy_CL(Policy):
    def __init__(self, env, task, camera, video_model, target_timestep, flow_model, resolution=(320, 240), plan_timeout=15, max_replans=0, log=False):
        self.env = env
        self.seg_ids = name2maskid[task]
    ...
    def calculate_next_plan(self):
        ...
        start = time.time()
        images = pred_video(self.video_model, self.target_timestep, image, self.task)
